...
public class Style {
    ...
    public JButton lightGrayButton(String name) {
        JButton button = new JButton();
        button.setText(name);
        button.setPreferredSize(new Dimension(100,35));
        button.setFocusable(false);
        button.setFont(f.mulish(13));
        button.setForeground(new Color(0x24245C));
        button.setBackground(new Color(0xFFFFFF));
        button.setBorder(BorderFactory.createLineBorder(Color.decode("#D0DDE5")));
        return button;
    }
